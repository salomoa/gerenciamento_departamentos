...
public class DepartamentoService {
    ...
    public DepartamentoModel criarPessoa(DepartamentoModel departamentoModel){
        return departamentoRepository.save(departamentoModel);
    }

    public Optional<DepartamentoModel> buscarId(Long id) { return departamentoRepository.findById(id); }
    ...
    public void deletar(Long id){ departamentoRepository.deleteById(id); }
